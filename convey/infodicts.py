...
phone_dial = re.compile(
    r"[+(]?(\d{0,6})"
)  # any prefix like `+420` or `(089)`, then up to 6 digits (there is no longer prefix)
...
phones = {
    ...
    254: "ke",
    255: "tz",
    524: "Zanzibar, in place of never-implemented +259",
    256: "ug",
    257: "bi",
    258: "mz",
    260: "zm",
    ...
    373: "md",
    374: "am",
    447: "Artsakh (landlines, formerly +7 893)",
    497: "Artsakh (mobile phones)",
    375: "by",
    376: "ad",
    377: "mc",
    378: "sm",
    ...
    389: "mk",
    39: "it",
    906698: " Vatican City (assigned +379 but not in use)",
    40: "om",
    41: "ch",
    420: "cz",
    421: "sk",
    ...
    76: "kz",
    77: "kz",
    7840: "Abkhazia - see also +995 44",
    7940: "Abkhazia - see also +995 44",
    ...
    995: "ge",
    534: "South Ossetia",
    544: "Abkhazia[4][5] - see also +7 840, 940",
    996: "kg",
    998: "uz",
}
